      ...
      public function getRevenue()
    {
      ...
      for($i = 0;$i<7; $i++)
        ...
        for($k=0;$k<12;$k++)
         ...
         return view('admin.reports.revenue',compact('disp_year_month','disp_week_data','disp_month_data','year_month','week_data','month_data','currentMonthName','currentYear','currentTime'));
  
     }


 public function getNextRevenue(Request $request)
    {
      $disp_month_data = [];
      $disp_year_month = [];
      $disp_week_data = [];
...
public function getPrevRevenue(Request $request)
    {
      $disp_month_data = [];
      $disp_year_month = [];
      $disp_week_data = [];
