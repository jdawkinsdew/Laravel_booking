...
(function() {
    ...
    var iconarray = [
        'icon-alert-octagon', 'icon-alert-circle', 'icon-activity', 'icon-alert-triangle', 'icon-align-center', 'icon-airplay', 'icon-align-justify', 'icon-align-left', 'icon-align-right', 'icon-arrow-down-left',
    ...
    for (var i = 0, l = iconarray.length; i < l; i++) {
        $('#icon-wrapper').append(
            ...
            '<i class="feather ' + iconarray[i] + '"></i> <small>feather ' + iconarray[i] + '</small>' +
            '</div>');
    }
