                        ...
                        <div class="col-12">
                            <div class="card sale-card">
                                <div class="card-header">
                                        <div class="row">                            
                                        <div class="col-sm-3"><h3>Website Basic Setting</h3></div>                                                                                                        
                                        <div class="col-sm-7"></div> 
                                        <div class="col-sm-2">
                                        <a href='#!' class='btn_newProvider btn btn-success' data-toggle='tooltip' style="float:right;"><i class='feather icon-file-plus display-5'>Add</i></a></div>
                                    </div>                                      
                                </div>
